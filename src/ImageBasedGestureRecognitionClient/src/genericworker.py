...
for p in icePaths:
	if os.path.isfile(p+'/ImageBasedGestureRecognition.ice'):
		...
		break
if not ice_ImageBasedGestureRecognition:
	print('Couldn\'t load ImageBasedGestureRecognition')
	sys.exit(-1)
...
class GenericWorker(QtCore.QObject):
	...
	def __init__(self, mprx):
		...
		self.image_based_gesture_recognition_proxy = mprx["ImageBasedGestureRecognitionProxy"]
